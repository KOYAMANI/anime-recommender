...
describe('<AnimeListContainer />', () => {
    const mockAnimes = [
        { id: 1, title: 'Chainsaw Man', image_url: 'https://cdn.myanimelist.net/images/anime/1806/126216l.jpg' },
        { id: 2, title: 'Tengen Toppa Gurren Lagann', image_url: 'https://cdn.myanimelist.net/images/anime/4/5123l.jpg' }
    ];
    ...
    test('renders without crashing', () => {
        ...
        mockAnimes.forEach((anime) => {
            ...
            const imageElement = screen.getByAltText('anime');
