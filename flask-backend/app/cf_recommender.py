...
class CFRecommender:
    ...
    #     anime_data, rating_data, on="anime_id", suffixes=["", "_user"]
    # )
    ...
    # anime_feature = anime_feature[
    #     anime_feature["user_id"].isin(counts[counts >= 200].index)
    # ]
    ...
    #                     anime_pivot.index[indices.flatten()[i]]
    #                 )
    #             )
    #         else:
